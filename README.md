...
## Output screen shots of proteus  :
 ...
 ![image](https://github.com/user-attachments/assets/fa7af4cc-e00e-4ad7-adc2-d8a45c0a2fbb)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![image](https://github.com/user-attachments/assets/7996b135-2600-46d1-b7bf-75560e428eb5)
...
![image](https://github.com/user-attachments/assets/47be30b4-f246-459a-938a-457bea5419b0)


TON = 0.6ms TOFF= 0.6ms TOTAL TIME = 1.2ms FREQUENCY = 1/(1.2ms) = 833.33Hz

FOR PULSE AT 700

![image](https://github.com/user-attachments/assets/1211dda1-37eb-48f8-8573-749db56e063a)


TON = 0.84ms TOFF= 0.36 TOTAL TIME = 1.2ms FREQUENCY = 1/(1.2ms) = 833.33Hz

FOR PULSE AT 900

![image](https://github.com/user-attachments/assets/35f4412a-a3c8-4f02-a9aa-98e2d6a96224)


TON = 1.08ms TOFF= 0.12ms TOTAL TIME = 1.2ms FREQUENCY = 1/(1.2ms) = 833.33Hz
